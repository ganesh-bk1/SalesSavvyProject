...
public class JWTToken {
	...
	public JWTToken(User user, String token, LocalDateTime created_at, LocalDateTime expiresAt) {
		super();
		this.user = user;
		this.token = token;
	...
	public JWTToken(Integer tokenId, User user, String token, LocalDateTime created_at, LocalDateTime expiresAt) {
		super();
